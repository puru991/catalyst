...
from catalyst.lib.adjusted_array import can_represent_dtype
...
class AssetExists(Term):
    ...
    See Also
    --------
    catalyst.assets.AssetFinder.lifetimes
    """
    dtype = bool_dtype
    dataset = None
    inputs = ()
...
class LoadableTerm(Term):
    ...
    This is the base class for :class:`catalyst.pipeline.data.BoundColumn`.
    """
    windowed = False
    inputs = ()
...
class Slice(ComputableTerm):
    ...
    Parameters
    ----------
    term : catalyst.pipeline.term.Term
